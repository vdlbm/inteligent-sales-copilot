...
export const mockEmails: EmailAnalysis[] = [
  {
    ...
    summary_original: "Cliente solicita propuesta para migración cloud con deadline crítico de 5 días. Presupuesto estimado 2M€.",
  ...
  },
  {
    ...
    summary_original: "Cliente interesado en soluciones de IA tras reunión. Solicita información adicional sobre Watson.",
  ...
  },
  {
    ...
    summary_original: "Consulta general de empresa pequeña sobre servicios cloud. Sin urgencia aparente.",
  ...
  },
  {
    ...
    summary_original: "Cliente existente solicita información sobre renovación de contrato que vence en 21 días.",
  ...
  },
  {
    ...
    summary_original: "Nuevo contacto del sector salud interesado en soluciones de ciberseguridad y cumplimiento normativo.",
